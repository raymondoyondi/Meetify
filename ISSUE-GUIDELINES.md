...
In all cases please use the [GitHub open issue search](https://github.com/raymondoyondi/Meetify/issues) to check whether the issue has already been reported.
...
1. Click on the [`New Issue`](https://github.com/raymondoyondi/Meetify/issues/new/choose) button
...
1. **Previously Assigned Issues**: We regularly review issues and add a [`no-issue-activity`](https://github.com/raymondoyondi/Meetify/issues?q=is%3Aissue+is%3Aopen+label%3Ano-issue-activity) label to them. Use the issue comments to ask whether the assignee is still working on the issue, and if not, ask for the issue to be assigned to you.
2. **Unassigned Issues**: If the issue is already reported and [not assigned to anyone](https://github.com/raymondoyondi/Meetify/issues?q=is%3Aissue+is%3Aopen+no%3Aassignee) and you are interested in working on the issue then:
   i. Ask for the issue to be assigned to you in the issue comments
